    ...
    switch (req.url) {
        ...
        case '/':
            ...
            res.write(`
                         ...
                         -Contacto (/contacto)
                         -Pregunatas Frecuentes (/preguntas-frecuentes)`)
            res.end()
        ...
        case '/mas-votadas':
            ...
            let masVotadas = movies.filter(function (peliculas) {
            ...
            var acumulador = 0
            var promedio = 0
            masVotadas.forEach(pelicula => {
                promedio = (acumulador = pelicula.vote_average + acumulador) / i
                i++
                return promedio
            });
            res.write('Valoración general: ' + promedio.toFixed(2) + '\n\n')

            masVotadas.forEach(movie => {
                res.write('- ' + movie.title+'\n')
                res.write('Valoración: ' + movie.vote_average+'\n')
                res.write('Descripción: \n' + movie.overview + '\n\n')
            });
        ...
        case '/sucursales':
            ...
            theaters.forEach(salas => {
                totalSalas = (acumulador = salas.total_rooms + acumulador)
                i++
                return totalSalas
            });
            ...
            theaters.forEach(sucursales => {
                res.write('- ' + sucursales.name)
                res.write('\n')
                res.write('Dirección: ' + sucursales.address)
                res.write('\n')
                res.write('Descripción: \n' + sucursales.description + '\n\n')
            });
        ...
        case '/preguntas-frecuentes':
            ...
            res.write('Top ' + faqs.length + ' de Preguntas Frecuentes:\n\n')
